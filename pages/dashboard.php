...
foreach ($tasks as $task) {
    ...
    if ($task['group_id'] != 0) {
        ...
        echo "<div style='float:right'><a class='btn btn-sm btn-outline-primary' href='index.php?page=survey&task_id=".$task['group_task_id']."&group=".$task['group_id']."&onD=1'><i class='fa fa-check-square-o'></i></a></div>";
    } else {
