...
if($is_group_task) {
    $sql = "UPDATE group_tasks SET group_id = ?, title = ?, due_date = ?, location = ?, description = ?, estimated_load = ?, category = ? WHERE task_id = ?";
    ...
    $location = "../../index.php?page=group&group_id=$group_id"; 
}
else {
